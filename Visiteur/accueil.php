			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="has-dropdown"><a href="#">Resultat</a></li>
			...
			<div class="gtco-flex">
				<div class="feature feature-1 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Rencontre</h3>
						<p>Vous pouvez entrer les informations concernant une rencontre</p>
				...
				<div class="feature feature-2 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Résultat</h3>
						<p>Vous pourrez mettre à jour l'issue d'un match passé</p>
						<p><a href="#" class="btn btn-white btn-outline">Mettre à jour Résultat</a></p>
					</div>
				</div>
				<!--
