					...
					<div class="display-t">
						<div class="display-tc">
							<p>
								...
								bien vrai que cette page n'est qu'une page de test on essayera de l'améliorer au file du temps
								</font>
							</p>
						</div>
					</div>
			...
			<div class="gtco-flex">
				<div class="feature feature-1 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Connexion</h3>
						<p>Veuillez vous connecter si il y a des modifications à apporter</p>
						<p><a href="connexion.html" class="btn btn-white btn-outline">Se connecter</a></p>
					</div>
				</div>
