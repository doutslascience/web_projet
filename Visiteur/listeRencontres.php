...
<html>
	...
	<?php $rencontres = recupRencontresNonTermines(); 
		...
		<div class="gtco-container">
			<div class="row">
			    ...
			    <div class="col-md-2"> 
			        ...
			        <a href='miseAjourRencontre.php?equipe1=<?php echo $value["id_equipe1"]; ?>&equipe2=<?php echo $value["id_equipe2"]; ?>&rencontre=<?php echo $value["id_rencontre"]; ?>'>
			...
			<div class=" col-md-4 col-md-offset-4">
				 <h3> Date : <?php echo $value["date_rencontre"]." ".$value["heure_rencontre"] ; ?></h3>
			</div>
		</div>
	</div>';
